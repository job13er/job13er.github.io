    ...
    1384: function(e, t) {
      e.exports = function(e) {
        var t = {
          ...
          o = [
            {
              ...
              endsWithParent: !0,
              relevance: 0,
              contains: [{className: 'literal', begin: /\.\.\./}, e.C_NUMBER_MODE, e.C_BLOCK_COMMENT_MODE, a, n]
            }
          ],
          s = {className: 'title', begin: e.UNDERSCORE_IDENT_RE, relevance: 0},
          d = function(t, r, n) {
            var d = e.inherit(
              {className: 'function', beginKeywords: t, end: r, excludeEnd: !0, contains: [].concat(o)},
              n || {}
            )
            return (
              d.contains.push(s),
          ...
          i = {className: 'string', begin: '"', end: '"', contains: [e.BACKSLASH_ESCAPE], relevance: 0},
          c = {
        ...
        return (
          c.contains.push(p),
          {
            ...
            contains: [
              ...
              d('proc keyword', ';'),
              d('fn', '='),
              {beginKeywords: 'for threadfor', end: /;/, relevance: 0, contains: [e.C_BLOCK_COMMENT_MODE, a, p]},
              {
                variants: [
