  ...
  [168],
  {
    1494: function(e, n) {
      e.exports = function(e) {
        ...
        return (
          (i.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, E, t, e.REGEXP_MODE]),
          {
            aliases: ['ts'],
            keywords: n,
            contains: [
              ...
              },
              {
                ...
                excludeEnd: !0,
                keywords: n,
                contains: ['self', e.inherit(e.TITLE_MODE, {begin: '[A-Za-z$_][0-9A-Za-z$_]*'}), s],
                illegal: /%/,
                relevance: 0
              },
              {beginKeywords: 'constructor', end: /[\{;]/, excludeEnd: !0, contains: ['self', s]},
