      ...
      e.exports = function(e) {
        var n = {
          ...
          t = {
            ...
            contains: [a, i, {className: 'variable', begin: /\$[A-z]/, end: /[^A-z]/}]
          },
          s = {
            className: 'string',
            variants: [
          ...
          d = {
            ...
            returnBegin: !0,
            contains: [t, s, {className: 'keyword', begin: /(using|assembly|command|module|namespace|type)/}]
          },
          m = {
            variants: [
              {
        ...
        return (
          p.contains.unshift(b),
          {
            aliases: ['ps', 'ps1'],
            lexemes: /-?[A-z\.\-]+/,
            case_insensitive: !0,
            keywords: n,
            contains: g.concat(r, l, d, m, b)
          }
        )
      }
    }
