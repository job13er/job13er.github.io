    ...
    1462: function(e, n) {
      e.exports = function(e) {
        var n = '~?[a-z$_][0-9a-zA-Z$_]*',
          ...
          t = {className: 'number', relevance: 0, variants: [{begin: l}, {begin: '\\(\\-' + l + '\\)'}]},
          c = {className: 'operator', relevance: 0, begin: s},
          o = [{className: 'identifier', relevance: 0, begin: n}, c, t],
          b = [
            e.QUOTE_STRING_MODE,
            c,
            {
                    ...
                    variants: [
                      {
                        ...
                        contains: [
                          c,
                          {className: 'typing', begin: ':', end: '(,|\\n)', returnBegin: !0, relevance: 0, contains: g}
                        ]
                      }
                    ]
                  }
        ...
        var m = {
            ...
            illegal: '\\n',
            keywords: r,
            contains: [e.QUOTE_STRING_MODE, c, {className: 'params', begin: '\\b' + n}]
          },
          u = {
            ...
            relevance: 0,
            contains: [m, c, {relevance: 0, className: 'constructor', begin: a}]
          },
          _ = {
            ...
            variants: [
              {begin: '\\b(' + a + '\\.)+' + n},
              {
                ...
                returnBegin: !0,
                contains: [d, {begin: '\\(', end: '\\)', skip: !0}].concat(b)
              },
              {begin: '\\b(' + a + '\\.)+{', end: '}'}
            ],
            contains: b
