    ...
    1400: function(e, a) {
      e.exports = function(e) {
        var a = "[a-zA-Z_\\-!.?+*=<>&#'][a-zA-Z_\\-!.?+*=<>&#'0-9/;:]*",
          ...
          f = [p, n, l, c, s, d, o, t, r, i]
        return (
          (p.contains = [e.COMMENT('comment', ''), u, m]),
          (m.contains = f),
          (o.contains = f),
          {
            aliases: ['hylang'],
            illegal: /\S/,
            contains: [{className: 'meta', begin: '^#!', end: '$'}, p, n, l, c, s, d, o, t, r]
          }
        )
      }
    }
