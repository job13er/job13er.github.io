    ...
    1504: function(e, n) {
      e.exports = function(e) {
        var n = {className: 'symbol', begin: '&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;'},
          ...
          t = e.inherit(e.QUOTE_STRING_MODE, {className: 'meta-string'}),
          l = {
            endsWithParent: !0,
            illegal: /</,
            relevance: 0,
          ...
          contains: [
            {
              ...
              contains: [
                ...
                s,
                {
                  ...
                  contains: [{className: 'meta', begin: '<![a-z]', end: '>', contains: [a, s, t, i]}]
                }
              ]
            },
            ...
            },
            {
              ...
              contains: [{className: 'name', begin: /[^\/><\s]+/, relevance: 0}, l]
            }
          ]
        }
      }
