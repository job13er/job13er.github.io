    ...
    1418: function(e, n) {
      e.exports = function(e) {
        var n = {
          ...
          t = {className: 'subst', begin: /#[A-Za-z$_]/, end: /(?:\-[0-9A-Za-z$_]|[0-9A-Za-z$_])*/, keywords: n},
          o = [
            ...
            },
            {
              ...
              variants: [
                ...
                {begin: /'/, end: /'/, contains: [e.BACKSLASH_ESCAPE]},
                {begin: /"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, a, t]},
                {begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, a, t]},
            ...
            },
            {
              className: 'regexp',
              variants: [
                {begin: '//', end: '//[gim]*', contains: [a, e.HASH_COMMENT_MODE]},
                {begin: /\/(?![ *])(\\.|[^\\\n])*?\/[gim]*(?=\W)/}
              ]
            },
            {begin: '@' + s},
        ...
        var d = {
          ...
          begin: '\\(',
          returnBegin: !0,
          contains: [{begin: /\(/, end: /\)/, keywords: n, contains: ['self'].concat(o)}]
        }
        return {
          aliases: ['ls'],
          keywords: n,
