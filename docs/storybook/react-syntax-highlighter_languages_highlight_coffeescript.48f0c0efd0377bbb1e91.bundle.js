  ...
  [31],
  {
    1352: function(n, e) {
      n.exports = function(n) {
          ...
          a = [
            ...
            n.inherit(n.C_NUMBER_MODE, {starts: {end: '(\\s*/)?', relevance: 0}}),
            {
              ...
              variants: [
                ...
                {begin: /'/, end: /'/, contains: [n.BACKSLASH_ESCAPE]},
                {begin: /"""/, end: /"""/, contains: [n.BACKSLASH_ESCAPE, s]},
                {begin: /"/, end: /"/, contains: [n.BACKSLASH_ESCAPE, s]}
              ]
            },
            {
              className: 'regexp',
              variants: [
                {begin: '///', end: '///', contains: [s, n.HASH_COMMENT_MODE]},
        ...
        s.contains = a
        var t = n.inherit(n.TITLE_MODE, {begin: i}),
          o = {
            className: 'params',
            begin: '\\([^\\(]',
            returnBegin: !0,
            contains: [{begin: /\(/, end: /\)/, keywords: e, contains: ['self'].concat(a)}]
          }
        return {
          ...
          contains: a.concat([
            ...
            },
            {
              ...
              relevance: 0,
              contains: [
                {className: 'function', begin: '(\\(.*\\))?\\s*\\B[-=]>', end: '[-=]>', returnBegin: !0, contains: [o]}
              ]
            },
            {
              className: 'class',
