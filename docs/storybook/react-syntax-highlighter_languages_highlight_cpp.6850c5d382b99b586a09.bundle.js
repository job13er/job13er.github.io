    ...
    1355: function(e, t) {
      e.exports = function(e) {
        ...
        var n = '(decltype\\(auto\\)|' + t('[a-zA-Z_]\\w*::') + '[a-zA-Z_]\\w*' + t('<.*?>') + ')',
          a = {className: 'keyword', begin: '\\b[a-z\\d_]*_t\\b'},
          r = {
            className: 'string',
            variants: [
          ...
          d = [a, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, s, r],
          _ = {
            variants: [
              {begin: /=/, end: /;/},
              {begin: /\(/, end: /\)/},
              ...
              {begin: c, returnBegin: !0, contains: [o], relevance: 0},
              {
                ...
                contains: [
                  ...
                  a,
                  {
                    ...
                    keywords: l,
                    relevance: 0,
                    contains: ['self', e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, r, s, a]
                  }
                ]
              },
              a,
        ...
        return {
          ...
          exports: {preprocessor: i, strings: r, keywords: l}
        }
      }
    }
  }
