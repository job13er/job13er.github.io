    ...
    1412: function(e, a) {
      e.exports = function(e) {
        var a = '\\]|\\?>',
          ...
          s = {className: 'meta', begin: '\\[/noprocess|<\\?(lasso(script)?|=)'},
          ...
          contains: [
            {
              ...
              begin: a,
              relevance: 0,
              starts: {end: '\\[|<\\?(lasso(script)?|=)', returnEnd: !0, relevance: 0, contains: [r]}
            },
            t,
            s,
            {
                ...
                contains: [
                  {
                    ...
                    begin: a,
                    relevance: 0,
                    starts: {end: '\\[noprocess\\]|<\\?(lasso(script)?|=)', returnEnd: !0, contains: [r]}
                  },
                  t,
                  s
                ].concat(l)
