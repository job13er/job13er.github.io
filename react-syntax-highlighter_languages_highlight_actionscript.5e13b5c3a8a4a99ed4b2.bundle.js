  ...
  [5],
  {
    1326: function(e, n) {
      e.exports = function(e) {
        var n = {className: 'rest_arg', begin: '[.]{3}', end: '[a-zA-Z_$][a-zA-Z0-9_$]*', relevance: 10}
        return {
          aliases: ['as'],
          keywords: {
            keyword:
            ...
            },
            {
              ...
              contains: [
                e.TITLE_MODE,
                {
                  ...
                  contains: [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, n]
                },
